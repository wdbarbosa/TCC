                        ...
                        <form action="{{ route('questoes.atualizar', $questao) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="text" name="assunto" id="assunto" value="{{ $questao->assunto }}" class="mt-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required placeholder="Não coloque caracteres especiais como '/' ">
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col">
                                ...
                                <select name="fk_disciplina_id" id="fk_disciplina_id" class="mt-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                    @foreach($disciplinas as $disciplina)
                                        <option value="{{ $disciplina->id }}" @if($disciplina->id == $questao->fk_disciplina_id) selected @endif>{{ $disciplina->nome_disciplina }}</option>
                                    @endforeach
                                </select>
                            </div>
