                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form action="{{ route('questoes.atualizar', $questao) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text" name="alternativacorreta" id="alternativacorreta" value="{{ $questao->alternativacorreta }}" class="mt-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>
