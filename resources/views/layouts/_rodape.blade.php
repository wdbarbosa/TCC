            ...
            <div class="row">
                ...
                <div class="footer-col">
                    ...
                    <div class="social-links">
                        <a href="https://www.facebook.com/cursinhoprimeirodemaio/?locale=pt_BR"><i class="fa fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/cursinhoprimeirodemaio/"><i class="fa fa-instagram"></i></a>
                    </div>
                </div>
                <div class="footer-col">
                ...
                <div class="footer-col">
                    <img src="{{ asset('img/primeirodemaio.png') }}" width="90" height="90" alt="Primeiro de Maio">
                </div>
                <div class="footer-col">
