<x-guest-layout>
    <form method="POST" action="{{ route('cadastrar-professor') }}">
        ...
        <div>
            ...
            <x-text-input style="background-color: #F4F4F4;" id="name" class="focus:border-cyan-200 block mt-1 w-full" type="text" name="name" :value="old('name')" required
        ...
        <div class="mt-4">
            ...
            <x-text-input style="background-color: #F4F4F4;" id="data_nasc" class="focus:border-cyan-200 block mt-1 w-full" type="date" name="data_nasc"
        ...
        <div class="mt-4">
            ...
            <x-text-input style="background-color: #F4F4F4;" id="cpf" class="focus:border-cyan-200 block mt-1 w-full" type="text" name="cpf" :value="old('cpf')"
        ...
        <div class="mt-4">
            ...
            <x-text-input style="background-color: #F4F4F4;" id="telefone" class="focus:border-cyan-200 block mt-1 w-full" type="text" name="telefone" :value="old('telefone')"
        ...
        <div class="mt-4">
            ...
            <x-text-input style="background-color: #F4F4F4;" id="email" class="focus:border-cyan-200 block mt-1 w-full" type="email" name="email" :value="old('email')" required
        ...
        <div class="mt-4">
            ...
            <x-text-input style="background-color: #F4F4F4;" id="password" class="focus:border-cyan-200 block mt-1 w-full" type="password" name="password" required 
        ...
        <div class="mt-4">
            ...
            <x-text-input style="background-color: #F4F4F4;" id="password_confirmation" class="focus:border-cyan-200 block mt-1 w-full" type="password"
