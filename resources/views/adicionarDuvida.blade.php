        ...
        <div class="w-full max-w-2xl bg-white border border-gray-200 rounded-lg shadow-lg p-8">
            <form method="POST" action="{{ route('cadastrar-duvida') }}">
                ...
                <div class="mb-6">
                    ...
                    <x-text-input id="nome" class="block mt-1 w-full rounded-md" type="text" name="nome" :value="old('nome')" requiredautofocus autocomplete="nome"
                ...
                <div class="mb-6">
                    ...
                    <textarea id="mensagem" class="block mt-1 w-full h-32 rounded-md" name="mensagem" required autofocus 
                        autocomplete="mensagem"style="background-color: #f9f9f9; border: 2px solid #d1d5db;" onfocus="this.style.borderColor='#66d6e3'" onblur="this.style.borderColor='#d1d5db'">{{ old('mensagem') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <x-text-input id="dataforum" class="block mt-1 w-full rounded-md" type="date" name="dataforum" :value="old('dataforum')" 
                        required autocomplete="username"readonlystyle="background-color: #f9f9f9; border: 2px solid #d1d5db;" onfocus="this.style.borderColor='#66d6e3'" 
